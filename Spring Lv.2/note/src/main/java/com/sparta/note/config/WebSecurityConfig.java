package com.sparta.note.config;

import com.sparta.note.jwt.JwtAuthorizationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) -> // authorizeHttpRequests : http에 대한 인증을 어떻게 할거냐?
